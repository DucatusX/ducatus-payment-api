# ducatus-payment OpenAPI Specification
[![Build Status](https://travis-ci.org/Ducatus/ducatus-payment-api.svg?branch=master)](https://travis-ci.org/Ducatus/ducatus-payment-api)
...
6. If you did everything correct, https://ducatus.github.io/ducatus-payment-api/ will lead to your new docs
...
- Documentation(ReDoc): https://ducatus.github.io/ducatus-payment-api/
- SwaggerUI: https://ducatus.github.io/ducatus-payment-api/swagger-ui/
- Look full spec:
    + JSON https://ducatus.github.io/ducatus-payment-api/swagger.json
    + YAML https://ducatus.github.io/ducatus-payment-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://ducatus.github.io/ducatus-payment-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://ducatus.github.io/ducatus-payment-api/ with url from the message: `Server started <url>`
